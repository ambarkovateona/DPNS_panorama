from stitch.image_stitching import utils
...
def recurse(image_list, no_of_images):
    """Recursive function to get panorama of multiple inputs

    Args:
        image_list (List): list of numpy array of inputs
        no_of_images (int): no of inputs read through cmdline
