...
class ImageStitching:
    """containts the utilities required to stitch inputs"""
    ...
    def give_gray(self, image):
        ...
        Args:
            image (numpy array): array of inputs

        Returns:
            image (numpy array): same as image input
            photo_gray (numpy array): grayscaled inputs
        """
    ...
    def compute_homography(
        ...
        """Computes the Homography to map inputs to a single plane,
    ...
    def create_mask(self, query_image, train_image, version):
        """Creates the mask using query and train inputs for blending the inputs,
    ...
    def blending_smoothing(self, query_image, train_image, homography_matrix):
        ...
        Args:
            query_image (numpy array)
            train_image (numpy array)
            homography_matrix (numpy array): Homography to map inputs to a single plane
